...
namespace Big
{
	...
	public:
		...
		using register_raw_file = DWORD(DWORD* result, const char* file, bool quitOnBadVersion, const char* relativePath, bool quitIfMissing, bool overlayIfExists);
		register_raw_file* m_register_raw_file;
	};
